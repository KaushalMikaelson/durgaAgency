  ...
  return (
    <aside className="sidebar">
      ...
      <ul className="nav-menu">
        <li>
          <button className="nav-item-btn active" data-tab="dashboard" onClick={() => window.app?.switchTab('dashboard')}>
        ...
        <li>
          <button className="nav-item-btn" data-tab="analytics" onClick={() => window.app?.switchTab('analytics')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="18" x2="18" y1="20" y2="10"/><line x1="12" x2="12" y1="20" y2="4"/><line x1="6" x2="6" y1="20" y2="14"/></svg>
            <span>Summary & Analytics</span>
            <span className="nav-badge" style={{ background: 'rgba(16,185,129,0.2)', color: '#059669', fontWeight: 700 }}>Stats</span>
          </button>
        </li>
        <li>
          <button className="nav-item-btn" data-tab="leads" onClick={() => window.app?.switchTab('leads')}>
        ...
        <li>
          <button className="nav-item-btn" data-tab="inventory" onClick={() => window.app?.switchTab('inventory')}>
        ...
        <li>
          <button className="nav-item-btn" data-tab="billing" onClick={() => window.app?.switchTab('billing')}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1Z"/><path d="M14 8H8"/><path d="M16 12H8"/><path d="M13 16H8"/></svg>
            <span>Billing & Bills</span>
          </button>
        </li>
        <li>
          <button className="nav-item-btn" data-tab="demos" onClick={() => window.app?.switchTab('demos')}>
        ...
        <li>
          <button className="nav-item-btn" data-tab="expenses" onClick={() => window.app?.switchTab('expenses')}>
        ...
        <li>
          <button className="nav-item-btn" data-tab="cashflow" onClick={() => window.app?.switchTab('cashflow')}>
        ...
        <li>
          <button className="nav-item-btn" data-tab="villageMap" onClick={() => window.app?.switchTab('villageMap')}>
        ...
        <li>
          <button className="nav-item-btn" data-tab="aiAdvisor" onClick={() => window.app?.switchTab('aiAdvisor')}>
